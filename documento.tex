...
\begin{frame}
	\frametitle{Diagrama de Pareto}

	\begin{block}{Defini\c cão}
		 É uma ferramenta de análise visual usada para identificar as causas mais significativas de um problema.
	\end{block}
\end{frame}
...
\begin{frame}
	...
	\begin{center}
		\includegraphics[scale=0.5]{img/grafico-pareto}
	\end{center}
\end{frame}
...
\begin{frame}
	...
	\begin{block}{Defini\c cão}
		 É um framework de gerenciamento que as equipes usam para se auto-organizar e trabalhar em direção a um objetivo em comum.
	\end{block}
\end{frame}

\begin{frame}
	\frametitle{Processo do Scrum}
